...
public class AddToCart {
    ...
    public AddToCart(boolean visibility){
        ...
        image.setIcon(new ImageIcon("C://Users//dsadm//Desktop//javaDelivery//deliveryJava//img//frame_addtocart.png"));
        ...
        btnAddToCart.addActionListener(e -> {
            ...
            System.out.println("Lanche Price: $"+price + " " + "Quantity: "+quantityInput);
            CalculateResult calculateResult = new CalculateResult(price, quantityInput);
            calculateResult.returnObject(calculateResult);
